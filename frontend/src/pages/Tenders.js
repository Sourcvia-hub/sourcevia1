          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="text-center">
                ...
                <p className="text-sm text-blue-600 font-medium mt-1">Total Tenders</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="text-center">
