...
**Expected:** `https://sourcevia-secure.preview.emergentagent.com`
...
2. Go to: https://sourcevia-secure.preview.emergentagent.com/login
...
```javascript
fetch('https://sourcevia-secure.preview.emergentagent.com/api/auth/login', {
  method: 'POST',
...
**URL:** https://sourcevia-secure.preview.emergentagent.com (not http://)
...
✅ API responds correctly: https://sourcevia-secure.preview.emergentagent.com/api
