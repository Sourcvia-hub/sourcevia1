...
**Expected:** `https://sourcevia-proc.preview.emergentagent.com`
...
2. Go to: https://sourcevia-proc.preview.emergentagent.com/login
...
```javascript
fetch('https://sourcevia-proc.preview.emergentagent.com/api/auth/login', {
  method: 'POST',
...
**URL:** https://sourcevia-proc.preview.emergentagent.com (not http://)
...
✅ API responds correctly: https://sourcevia-proc.preview.emergentagent.com/api
...
```bash
curl -X POST "https://sourcevia-proc.preview.emergentagent.com/api/auth/login" \
